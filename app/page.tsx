...
import DynamicSVG from '@/components/ui/soliditySvg'
        ...
        >
          <div className="flex-1">
            <p className="text-zinc-600 dark:text-zinc-400">
              Working across backend systems in Go, full-stack web development,
              and iOS app development to create smooth, reliable user
              experiences.
            </p>
          </div>
        </motion.section>
